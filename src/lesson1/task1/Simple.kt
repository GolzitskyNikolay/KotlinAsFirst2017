 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int): Double = PI/180.0 *(grad + min/60.0 + sec/3600.0)
 ...
 */
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int = abs((hoursArrive*60+minutesArrive)-(hoursDepart*60+minutesDepart))
